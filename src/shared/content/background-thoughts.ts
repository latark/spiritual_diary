 ...
 * ⚠️ Позитивные эмоции распределены неровно: «Любовь/Покой/Радость» — хорошо, «Интерес» — слабо.
 * «Удивление» (surprise) в методичке не покрыто — закрыто отдельными записями 51–52 (тексты от Артёма).
 */
